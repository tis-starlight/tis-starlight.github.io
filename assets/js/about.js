...
const tools = [
  ...
  // { icon: 'zbrush' },
  // { icon: 'plasticity' },
  { icon: 'fusion', iconType: 'plain', tag: 'fusion', hint: 'Fusion 360', isClickable: false },
  // { icon: 'rizomuv' },
  // { icon: 'daz3d' },
  ...
  { icon: 'kalilinux', iconType: 'original', tag: 'kalilinux', hint: 'Kali Linux', isClickable: false },
  // { icon: 'cheatengine' },
  // { icon: 'hexraysida' },
];
