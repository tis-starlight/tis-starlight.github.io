---
title: 0.2 - Programming Languages      # TITLE for the post
...
image:      
  path: /assets/img/posts/programming-languages.jpg    # image path. forward slash (/)
  lqip: data:image/jpg;base64,UklGRjAAAABXRUJQVlA4ICQAAACQAQCdASoFAAMAAkA4JaQAAudZtgAA/v2xdHF2ayXsBgAAAAA=
  alt: Programming Languages   # displayed under the image (caption) 
